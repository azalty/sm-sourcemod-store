 ...
 * @noreturn
 */ 
AddMainMenuItem(const String:displayName[], const String:description[] = "", const String:value[] = "", Handle:plugin = INVALID_HANDLE, Function callback = INVALID_FUNCTION, order = 32)
{
	new item;
